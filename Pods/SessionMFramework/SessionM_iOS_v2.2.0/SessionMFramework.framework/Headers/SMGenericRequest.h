...
/*!
 @typedef tokenType
 @abstract Authentication mechanism that the server will use when processing the request.
 */
@property(nonatomic, assign, readonly) SMRequestTokenType tokenType;
...
/*!
 ...
 @param tokenType Authentication mechanism that the server will use when processing the request.
...
- (instancetype)initWithBody:(NSDictionary<NSString *, NSObject *> *)body
                ...
                urlFormatter:(URLFormatter)urlFormatter
                     headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers
                   tokenType:(SMRequestTokenType)tokenType;
