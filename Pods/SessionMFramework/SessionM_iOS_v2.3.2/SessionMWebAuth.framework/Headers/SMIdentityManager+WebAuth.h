...
/*!
 ...
 @result <code>BOOL</code> indicating whether the authentication request will be sent.
 */
- (BOOL)startWebAuthorizationForAuthCodeInViewController:(UIViewController *)presenting completionHandler:(didRequestAuthCode)completionHandler NS_SWIFT_NAME(startWebAuthorizationForAuthCode(in:completionHandler:));
/*!
