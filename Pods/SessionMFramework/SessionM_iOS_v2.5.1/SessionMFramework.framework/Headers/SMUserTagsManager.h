 ...
 */
typedef void (^didFetchUserTags)( NSDictionary<NSString *, NSObject *> * _Nullable tags, SMError * _Nullable error) NS_SWIFT_NAME(FetchUserTagsCompletionHandler);
/*!
 ...
 */
typedef void (^didUpdateUserTags)(NSDictionary<NSString *, NSObject *> * _Nullable tags, SMError * _Nullable error) NS_SWIFT_NAME(UpdateUserTagsCompletionHandler);
