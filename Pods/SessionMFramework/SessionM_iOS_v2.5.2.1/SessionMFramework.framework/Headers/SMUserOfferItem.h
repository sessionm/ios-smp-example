 ...
 */
@property(nonatomic, strong, readonly) NSString *acquireDate;
/*!
 @property expirationDate
 @abstract The date after which the offer item can no longer be redeemed by the user.
 */
@property(nullable, nonatomic, strong, readonly) NSString *expirationDate;
/*!
 @property redeemDate
 @abstract Indicates when the offer item was redeemed by the user.
 */
@property(nullable, nonatomic, strong, readonly) NSString *redeemDate;
