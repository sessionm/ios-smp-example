...
/*!
 @const kUserLocale
 @abstract Used to access the @link locale @/link value when using @link asDictionary @/link.
 @discussion Using the <code>kUserDeltas</code> key on a @link SM_USER_MANAGER_DID_UPDATE_USER @/link notification's <code>userInfo</code> property will return a set containing this string if the @link locale @/link property was updated (see @link //apple_ref/occ/cl/SMUserManager @/link for more details).
 */
...
/*!
 ...
 @abstract Used to access the @link currentCity @/link value when using @link asDictionary @/link.
 @discussion Using the <code>kUserDeltas</code> key on a @link SM_USER_MANAGER_DID_UPDATE_USER @/link notification's <code>userInfo</code> property will return a set containing this string if the @link currentCity @/link property was updated (see @link //apple_ref/occ/cl/SMUserManager @/link for more details).
 */
...
/*!
 @const kUserReferrerCode
 @abstract Used to access the @link referrerCode @/link value when using @link asDictionary @/link.
 */
extern NSString *const kUserReferrerCode;
/*!
 @const kUserCity
 @abstract Used to access the @link city @/link value when using @link asDictionary @/link.
 @discussion Using the <code>kUserDeltas</code> key on a @link SM_USER_MANAGER_DID_UPDATE_USER @/link notification's <code>userInfo</code> property will return a set containing this string if the @link city @/link property was updated (see @link //apple_ref/occ/cl/SMUserManager @/link for more details).
 */
...
/*!
 ...
 @abstract A referral code that can be provided by another user when creating or updating an account as part of a refer-a-friend program.
 */
@property(nullable, nonatomic, strong, readonly) NSString *referrerCode;
/*!
 @property extras
