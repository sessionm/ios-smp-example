 ...
 */
@property(nullable, nonatomic, strong, readonly) NSString *time;
/*!
 @property channel
 ...
 */
@property(nonatomic, assign, readonly) NSInteger overridePrice;
/*!
 ...
 */
@property(nonatomic, assign, readonly) NSInteger subtotal;
/*!
 @property total
