...
/*!
 ...
 @discussion An @link SMFetchStoreOffersResponse @/link object can be accessed from the notification's <code>userInfo</code> property with the @link SM_MANAGER_NOTIFICATION_DATA_KEY @/link key.
 */
...
/*!
 ...
 @discussion An @link SMPurchaseOfferResponse @/link object can be accessed from the notification's <code>userInfo</code> property with the @link SM_MANAGER_NOTIFICATION_DATA_KEY @/link key.
 */
...
/*!
 ...
 @discussion An @link SMFetchUserOffersResponse @/link object can be accessed from the notification's <code>userInfo</code> property with the @link SM_MANAGER_NOTIFICATION_DATA_KEY @/link key.
 */
...
/*!
 ...
 @discussion An @link SMClaimUserOfferResponse @/link object can be accessed from the notification's <code>userInfo</code> property with the @link SM_MANAGER_NOTIFICATION_DATA_KEY @/link key.
 */
 ...
 */
typedef void (^FetchStoreOffersCompletionHandler)(SMFetchStoreOffersResponse * _Nullable response, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^PurchaseOfferCompletionHandler)(SMPurchaseOfferResponse * _Nullable response, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^FetchUserOffersCompletionHandler)(SMFetchUserOffersResponse * _Nullable response, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^ClaimUserOfferCompletionHandler)(SMClaimUserOfferResponse * _Nullable response, SMError * _Nullable error);
