...
/*!
 @property codeCreationDate
 @abstract Indicates when the redemption code was created.
 */
@property(nonatomic, strong, readonly) NSDate *codeCreationDate;
/*!
 @property codeExpirationDate
 @abstract The date after which the redemption code can no longer be used to redeem the offer item.
 */
@property(nonatomic, strong, readonly) NSDate *codeExpirationDate;
