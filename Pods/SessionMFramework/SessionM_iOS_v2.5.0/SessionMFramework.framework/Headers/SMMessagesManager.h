 ...
 */
- (BOOL)handleRemoteNotification:(NSDictionary<NSString *, NSObject *> *)payload handler:(_Nullable NotificationHandler)handler NS_SWIFT_NAME(handleRemoteNotification(payload:handler:));
/*!
