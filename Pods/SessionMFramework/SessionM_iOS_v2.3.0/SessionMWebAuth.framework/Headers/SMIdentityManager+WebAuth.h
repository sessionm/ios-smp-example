...
/*!
 ...
 @result <code>BOOL</code> indicating whether the authentication request will be sent.
 */
- (BOOL)startWebAuthorizationInViewController:(UIViewController *)presenting completionHandler:(didUpdateAuthState)completionHandler NS_SWIFT_NAME(startWebAuthorization(in:completionHandler:));
/*!
 @abstract Attempts to handle the provided OAuth response redirect URI to continue authorization.
 @discussion A call to this method must be added to your application delegate's <code>application:openURL:options:</code> method to handle OAuth response redirects from @link startWebAuthorizationInViewController:completionHandler: @/link method calls.
