...
/*!
 @typedef ResponseVerificationHandler
 @abstract Block type for verifying request response data.
 */
typedef BOOL(^ResponseVerificationHandler)(NSDictionary *result, NSString * _Nonnull * _Nullable status, NSDictionary<NSString *, NSString *> * _Nonnull * _Nonnull error);

/*!
 @typedef CompletionHandler
 @abstract Completion handler block type for @link sendRequest:responseVerificationHandler:completionHandler: @/link.
 */
...
/*!
 @abstract Sends an HTTP request with the specified response verification and completion handlers.
 @param request Request to be sent.
 @param responseVerificationHandler The block to execute to verify the request response.
 @param completionHandler The block to execute after the request is processed.
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)sendRequest:(SMGenericRequest * _Nonnull)request responseVerificationHandler:(ResponseVerificationHandler _Nullable)responseVerificationHandler completionHandler:(CompletionHandler _Nonnull)completionHandler;
