...
/*!
 ...
 @discussion This property is updated in response to a successful <code>fetchUserWithCompletionHandler:</code> or <code>updateUser:completionHandler:</code> call - or to an internal change in the user's points value or authentication state (see <code>SessionMOAuthProviderIDP</code>).
 */
