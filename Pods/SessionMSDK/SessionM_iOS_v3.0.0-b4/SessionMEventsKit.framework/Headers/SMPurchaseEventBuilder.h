...
/*!
 ...
 @abstract Class used for building <code>SMPurchaseEvent</code> objects that represent an event performed by the user that contains purchase metadata such as product SKUs.
 */
...
/*!
 @discussion This method is unavailable - use <code>builder</code> instead.
 */
+ (instancetype)builderForEventWithName:(NSString *)eventName NS_SWIFT_NAME(builder(eventName:)) NS_UNAVAILABLE;

/*!
 @discussion This method is unavailable - use <code>init</code> instead.
 */
...
/*!
 ...
 @result The generated <code>SMPurchaseEvent</code> object.
 */
