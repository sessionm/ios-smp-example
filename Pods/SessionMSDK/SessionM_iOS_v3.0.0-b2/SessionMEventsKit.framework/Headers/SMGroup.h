...
/*!
 @property totalCount
 @abstract Total number of goals that need to be completed in order to complete the rule group (note: this value may be different from <code>numGoals</code> if some of the goals in the rule group are not required).
 */
