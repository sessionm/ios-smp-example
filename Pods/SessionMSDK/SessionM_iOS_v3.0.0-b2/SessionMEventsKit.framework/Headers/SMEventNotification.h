...
/*!
 @property actionType
 @abstract Determines how the content pointed to by <code>actionURL</code> is displayed.
 */
 ...
 */
@property(nullable, nonatomic, strong, readonly) NSDictionary<NSString *, id> *payload;
/*!
 @property data
