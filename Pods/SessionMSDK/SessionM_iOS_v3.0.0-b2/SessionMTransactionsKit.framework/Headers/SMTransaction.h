...
/*!
 ...
 @constant SMTransactionPointsTypeHistorical Indicates that the transaction data was migrated into the SessionM Platform from an external rewards system.
 */
...
/*!
 @abstract Converts specified string value to the corresponding <code>SMTransactionKind</code> enum value.
 @param string String to convert.
 @result <code>SMTransactionKind</code> enum value.
 */
+ (SMTransactionKind)transactionKindForString:(NSString *)string NS_SWIFT_NAME(transactionKind(from:));
/*!
 @abstract Converts specified string value to the corresponding <code>SMTransactionSource</code> enum value.
 @param string String to convert.
 @result <code>SMTransactionSource</code> enum value.
 */
+ (SMTransactionSource)transactionSourceForString:(NSString *)string NS_SWIFT_NAME(transactionSource(from:));
/*!
 @abstract Converts specified string value to the corresponding <code>SMTransactionPointsType</code> enum value.
 @param string String to convert.
 @result <code>SMTransactionPointsType</code> enum value.
 */
+ (SMTransactionPointsType)transactionPointsTypeForString:(NSString *)string NS_SWIFT_NAME(transactionPointsType(from:));

/*!
 @abstract Converts specified <code>SMTransactionKind</code> enum value to the corresponding string value.
...
/*!
 @abstract Converts specified <code>SMTransactionSource</code> enum value to the corresponding string value.
...
/*!
 @abstract Converts specified <code>SMTransactionPointsType</code> enum value to the corresponding string value.
