...
/*!
 ...
 @abstract Maximum value for <code>distance</code> for which the user can check in.
 */
...
/*!
 @abstract Converts specified string value to the corresponding <code>SMCheckinStatus</code> enum value.
 @param string String to convert.
 @result <code>SMCheckinStatus</code> enum value.
 */
+ (SMCheckinStatus)statusForString:(NSString *)string NS_SWIFT_NAME(checkinStatus(from:));
/*!
 @abstract Converts specified <code>SMCheckinStatus</code> enum value to the corresponding string value.
