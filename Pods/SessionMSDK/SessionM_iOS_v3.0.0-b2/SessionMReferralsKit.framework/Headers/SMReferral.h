...
/*!
 @abstract Converts specified string value to the corresponding <code>SMReferralStatus</code> enum value.
 @param string String to convert.
 @result <code>SMReferralStatus</code> enum value.
 */
+ (SMReferralStatus)statusForString:(NSString *)string NS_SWIFT_NAME(referralStatus(from:));
/*!
 @abstract Converts specified <code>SMReferralStatus</code> enum value to the corresponding string value.
