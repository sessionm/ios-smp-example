...
/*!
 ...
 @discussion An <code>NSArray</code> of <code>SMInboxMessage</code> objects can be accessed from the notification's <code>userInfo</code> property with the <code>SM_MANAGER_NOTIFICATION_DATA_KEY</code> key.
 */
...
/*!
 ...
 @discussion An <code>SMInboxMessage</code> object can be accessed from the notification's <code>userInfo</code> property with the <code>SM_MANAGER_NOTIFICATION_DATA_KEY</code> key.
 */
...
/*!
 ...
 @abstract Completion handler block type for <code>fetchInboxMessagesWithCompletionHandler:</code>.
 */
...
/*!
 ...
 @abstract Completion handler block type for <code>updateInboxMessage:state:completionHandler:</code>, <code>updateInboxMessageID:state:completionHandler:</code> and <code>updateInboxMessageIDs:state:completionHandler:</code>.
 */
...
/*!
 ...
 @abstract Completion handler block type for <code>createInboxMessage:completionHandler:</code>.
 */
 ...
 */
@interface SMInboxManager : SMBaseManager

/*!
 @property inboxMessages
 @abstract The current user's inbox messages.
 @discussion This property is updated in response to a successful <code>fetchInboxMessagesWithCompletionHandler:</code> call.
 */
@property(nonatomic, strong, readonly) NSArray<SMInboxMessage *> *inboxMessages;

/*!
 @abstract Makes a request to update <code>inboxMessages</code> with the current user's inbox messages.
 @param completionHandler The block to execute after the request is processed.
 */
- (void)fetchInboxMessagesWithCompletionHandler:(didFetchInboxMessages)completionHandler NS_SWIFT_NAME(fetchMessages(completionHandler:));
/*!
 ...
 @param completionHandler The block to execute after the request is processed.
 */
- (void)updateInboxMessage:(SMInboxMessage *)message state:(SMInboxMessageState)state completionHandler:(didUpdateInboxMessages)completionHandler NS_SWIFT_NAME(updateMessage(_:toState:completionHandler:));
/*!
 ...
 @param completionHandler The block to execute after the request is processed.
 */
- (void)updateInboxMessageID:(NSString *)messageID state:(SMInboxMessageState)state completionHandler:(didUpdateInboxMessages)completionHandler NS_SWIFT_NAME(updateMessage(havingID:toState:completionHandler:));
/*!
 ...
 @param completionHandler The block to execute after the request is processed.
 */
- (void)updateInboxMessageIDs:(NSArray<NSString *>*)messageIDs state:(SMInboxMessageState)state completionHandler:(didUpdateInboxMessages)completionHandler NS_SWIFT_NAME(updateMessages(havingIDs:toState:completionHandler:));
/*!
 ...
 @param completionHandler The block to execute after the request is processed.
 */
- (void)createInboxMessage:(SMNewInboxMessage *)message completionHandler:(didCreateInboxMessage)completionHandler NS_SWIFT_NAME(createMessage(_:completionHandler:));
