 ...
 */
@property(nullable, nonatomic, strong, readonly) NSDictionary<NSString *, id> *metadata;
/*!
 @property data
 @abstract Contains optional configuration such as a message body or deep link URL.
 */
@property(nullable, nonatomic, strong, readonly) NSDictionary<NSString *, id> *data;
/*!
 @property extras
...
/*!
 @abstract Converts specified string value to the corresponding <code>SMInboxMessageState</code> enum value.
 @param string String to convert.
 @result <code>SMInboxMessageState</code> enum value.
 */
+ (SMInboxMessageState)stateForString:(NSString *)string NS_SWIFT_NAME(messageState(from:));
/*!
 @abstract Converts specified <code>SMInboxMessageState</code> enum value to the corresponding string value.
...
/*!
 ...
 @abstract Metadata associated with the message.
 */
@property(nullable, nonatomic, strong) NSDictionary<NSString *, id> *metadata;
/*!
 @property data
 @abstract Contains optional configuration such as a message body or deep link URL.
 */
@property(nullable, nonatomic, strong) NSDictionary<NSString *, id> *data;
...
/*!
 ...
 @result <code>SMNewInboxMessage</code> instance.
 */
- (instancetype)initWithSubject:(NSString *)subject data:(NSDictionary<NSString *, id> * _Nullable)data metadata:(NSDictionary<NSString *, id> * _Nullable)metadata NS_SWIFT_NAME(init(subject:data:metadata:));
/*!
 @abstract Creates a new instance of <code>SMNewInboxMessage</code> with the specified parameters.
 @param subject Message subject.
 @param body Message body.
 ...
 @result <code>SMNewInboxMessage</code> instance.
 */
- (instancetype)initWithSubject:(NSString *)subject body:(NSString * _Nullable)body data:(NSDictionary<NSString *, id> * _Nullable)data metadata:(NSDictionary<NSString *, id> * _Nullable)metadata NS_SWIFT_NAME(init(subject:body:data:metadata:));
