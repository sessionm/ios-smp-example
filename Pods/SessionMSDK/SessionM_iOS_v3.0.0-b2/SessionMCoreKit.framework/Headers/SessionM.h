 ...
 */
+(void)setLogCategory:(SMLogCategory)category;
/*!
 @property pluginSDK
...
+(void)setCustomLocale:(NSLocale * _Nullable)customLocale;
/*!
...
+(void)setAuthenticationProvider:(nullable id<SMAuthenticationProvider>)authenticationProvider completionHandler:(nullable OnAuthenticationProviderSetFromAuthenticationProvider)onCompletion;
 ...
 */
+ (void)startWithAuthenticationProvider:(nullable id<SMAuthenticationProvider>)provider CompletionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(authenticationProvider:completionHandler:));
/*!
 ...
 */
+ (void)startWithConfigFileInBundleWithIdentifier:(NSString *)bundleID authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(havingIdentifier:authenticationProvider:completionHandler:));
/*!
 ...
 */
+ (void)startWithConfigFileServerType:(SMPServerType)type authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(havingServerType:authenticationProvider:completionHandler:));
/*!
 ...
 @param bundleID Identifier for the bundle in which the SDK will look for the configuration file.
 */
+ (void)startWithConfigFileServerType:(SMPServerType)type bundleIdentifier:(NSString *)bundleID authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(havingServerType:bundleIdentifier:authenticationProvider:completionHandler:));
/*!
 ...
 */
+ (void)startWithConfigFileName:(NSString *)name authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(fileName:authenticationProvider:completionHandler:));
/*!
 ...
 @param bundleID Identifier for the bundle in which the SDK will look for the configuration file.
 */
+ (void)startWithConfigFileName:(NSString *)name bundleIdentifier:(NSString *)bundleID authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(fileName:bundleIdentifier:authenticationProvider:completionHandler:));
/*!
 ...
 */
+ (void)startWithConfigFileAtPath:(NSString *)path authProvider:(nullable id<SMAuthenticationProvider>)authProvider completionHandler:(nullable SMPStartupHandler)onCompletion NS_SWIFT_NAME(start(filePath:authenticationProvider:completionHandler:));
