...
/*!
 ...
 @abstract Class used for building simple <code>SMEvent</code> objects that represent a single event performed by the user to make progress towards completing an application-specific campaign.
 */
