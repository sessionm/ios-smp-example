...
#import <SessionMMessagesKit/SMNotificationMessage.h>
 ...
 */
@property(nullable, nonatomic, strong, readonly) SMNotificationMessage *message;
/*!
 @property placeID
 ...
 */
@property(nullable, nonatomic, strong, readonly) NSString *canCheckInAgainAt;
/*!
 @property extras
