...
/*!
 @abstract Converts specified string value to the corresponding <code>SMOfferStatus</code> enum value.
 @param string String to convert.
 @result <code>SMOfferStatus</code> enum value.
 */
+ (SMOfferStatus)statusForString:(NSString *)string NS_SWIFT_NAME(offerStatus(from:));
/*!
 @abstract Converts specified <code>SMOfferStatus</code> enum value to the corresponding string value.
