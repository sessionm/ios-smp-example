...
/*!
 @abstract Presents an instance of <code>SFSafariViewController</code> that points to a web page where the user's account information can be viewed and updated.
