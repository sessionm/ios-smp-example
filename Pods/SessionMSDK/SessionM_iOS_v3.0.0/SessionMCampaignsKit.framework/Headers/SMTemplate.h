...
/*!
 ...
 @discussion Identical to <code>callToAction</code>.
 */
...
/*!
 ...
 @abstract Message subtitle.
 @discussion Identical to <code>subheader</code>.
 */
...
/*!
 @property type
 @abstract Determines how the content pointed to by <code>url</code> is displayed when <code>executeMessageAction:</code> is called with the corresponding SMFeedMessage @/link instance.
 */
@property(nullable, nonatomic, strong, readonly) NSString *type;
/*!
 @property url
 @abstract URL for content that is displayed when <code>executeMessageAction:</code> is called with the corresponding SMFeedMessage @/link instance.
 */
