...
/*!
 @abstract The currently set push environment (the default value is <code>SMPushEnvironmentLive</code>).
 ...
 */
@property(nonatomic, assign, readwrite) SMPushEnvironment pushEnvironment;
/*!
